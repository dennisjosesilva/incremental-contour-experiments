...
def main(OUTPUT_FILE_NAME= "runtime-checkboard-2/runtime_checkboard_0.csv",
         IMAGE_BASE_PATH = "../checkboard",
  ...
  RUNTIME_PROGRAM_CALLS = [
    ProgramCalls("chessboard16.pgm"),
    ProgramCalls("chessboard32.pgm"),
    ProgramCalls("chessboard64.pgm"),
    ProgramCalls("chessboard128.pgm"),
    ProgramCalls("chessboard256.pgm"),
    ProgramCalls("chessboard512.pgm"),
    ProgramCalls("chessboard1024.pgm"),
    ProgramCalls("chessboard2048.pgm"),
    ProgramCalls("chessboard4096.pgm")]
